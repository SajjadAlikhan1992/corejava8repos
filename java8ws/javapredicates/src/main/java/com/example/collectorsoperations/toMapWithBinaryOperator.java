...
public class toMapWithBinaryOperator {
    public static void main(String[] args) {
        ...
        Map<Integer, String> stringMap = employees.stream().collect(Collectors.toMap(Employee::getEmpId, Employee::getEmpName, (name1, name2) -> name1));
